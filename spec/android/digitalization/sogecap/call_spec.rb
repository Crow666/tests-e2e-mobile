...
#sleep(3)
puts"call number"
driver.find_element(:xpath, "//android.view.View[1]/android.widget.FrameLayout[2]/android.widget.RelativeLayout[2]/android.widget.FrameLayout[1]/android.support.v4.view.ViewPager[1]/android.widget.LinearLayout[1]/android.widget.RelativeLayout[1]").send_keys("+33969362362")
#sleep(3)
